...
function Programacao() {
  return <section id="programacao" className="mx-auto max-w-[1200px] bg-[#f5f7f8] px-[6vw] py-20 min-[701px]:px-[5vw] min-[701px]:py-[120px]">
